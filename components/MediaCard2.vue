...
.media-card {
  ...
  .holder {
    ...
    .image {
      /* Remove fixed width constraints/media queries if we want image driven */
      ...
      @include media("<md") {
        /* On mobile, we might still want the row layout behavior? */
        /* But for Carousel Advanced, we probably want consistent behavior */
        /* Let's strip the mobile overrides for .image for now or keep default */
        width: 112px;
        height: 112px;
        flex: 0 0 auto;
      }
